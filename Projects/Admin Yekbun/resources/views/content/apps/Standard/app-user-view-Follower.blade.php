 ...
 <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item"><a class="nav-link active" href="{{url('standard/app/user/view/Follower')}}"><i class="bx bx-user me-1"></i>Follower</a></li>
      ...
      <li class="nav-item"><a class="nav-link" href="{{url('standard/app/user/view/Location')}}"><i class="bx bx-map-pin me-1"></i>Location</a></li>
    </ul>
    <!--/ User Pills -->
