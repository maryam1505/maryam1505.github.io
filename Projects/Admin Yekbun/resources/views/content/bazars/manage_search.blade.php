...
<style>
  ...
  <div class="col-sm-6 col-xl-4">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            <span>Total Blocked search</span>
            <div class="d-flex align-items-end mt-2">
  ...
  <div class="card">
    ...
    <!--</ul>-->
      <ul class="nav nav-tabs nav-fill" role="tablist">
      <li class="nav-item" role="presentation">
        <a type="button" class="nav-link {{ $view === 'new_request'? 'active': '' }}" href="?view=new_request" aria-selected="true"><i class="tf-icons bx bxs-edit me-1"></i> Active search</a>
        <div class="{{ $view === 'new_request'? 'tab--selected': '' }} tab__slider"></div>
      </li>
      <li class="nav-item" role="presentation">
        <a type="button" class="nav-link {{ $view === 'request_on_hold'? 'active': '' }}" href="?view=request_on_hold" aria-selected="false" tabindex="-1"><i class="tf-icons bx bxs-edit me-1"></i> Blocked search</a>
