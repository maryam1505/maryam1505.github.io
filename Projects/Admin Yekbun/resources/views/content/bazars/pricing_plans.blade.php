...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Wizard examples /</span> Pricing Plans
</h4>
...
<div class="row">
   ...
   <div class="main_side_bar mt-3" style="
    padding: 5px;
">
        <h5 class="d-flex justify-content-center">Wishes and Thanks</h5>
        <div style="background: #e4e4e4;padding:15px;border-radius:10px;" class="coloun">
            <div class="d-flex justify-content-between">
                <div class="d-flex justify-content-inline">
                    <img src="https://yekbun.hellodev.site/public//assets/img/image_newww.png" alt="" width="20px" height="25px">
                     
                    <h5>Standard</h5>
                </div>
                <div class="d-flex justify-content-inline">
                    <p>Free</p>
                    <!--<img src="https://yekbun.hellodev.site/public//assets/img/tick.PNG" alt="" width="20px" height="20px">-->
...
<div style="padding:15px;background: #e4e4e4;;border-radius:10px;" class="coloun mt-4">
    <div class="d-flex justify-content-between ">
        <div class="d-flex justify-content-inline ">
            <img src="https://yekbun.hellodev.site/public//assets/img/image_star2.png" alt="" width="20px" height="25px">
            <h5>Starter</h5>
        </div>
        <div class="d-flex justify-content-inline">
            <p>9,99€</p>
...
<div style="padding:15px;background: #e4e4e4;;border-radius:10px;" class="coloun mt-4">
    <div class="d-flex justify-content-between">
        <div class="d-flex justify-content-inline mt-1 ">
            <img src="https://yekbun.hellodev.site/public//assets/img/image_star.png" alt="" width="20px" height="25px">
            <h5>Advanced</h5>
        </div>
        <div class="d-flex justify-content-inline">
            <p>19,99€</p>
