...
<form id="editForm{{ $donation->_id }}" action="{{ route('edit.donation', $donation->_id) }}" method="post" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
                ...
                @if ($donation->image)
                    <div class="col-md-12 limited-banner bg-custom-grey rounded-3 py-2 border-secondary border-dashed banner-wrapper cursor-pointer">
