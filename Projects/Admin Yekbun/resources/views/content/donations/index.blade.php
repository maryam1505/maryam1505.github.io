...
<div class="row g-4 mb-4">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex justify-content-end gap-2">
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createLimitedModal"><i class="bx bx-plus me-0 me-sm-1"></i> Limited Donation</button>
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createUnlimitedModal"><i class="bx bx-plus me-0 me-sm-1"></i> Unlimited Donation</button>
        </div>
        @can('donation.create')
        @endcan
    </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center gap-2">
                <img src="{{asset('storage/'. $donation->image)}}" alt="{{ $donation->title }}" class="rounded-circle" style="width: 2.8vw;height:2.8vw;">
            ...
            <td>
              <div class="form-check form-switch">
                <input class="form-check-input closetogglebtn" type="checkbox" id="flexSwitchCheckChecked " @if ($donation->status) checked @endif>
              </div>
            </td>
            ...
            <td>
              <div class="dropdown">
                ...
                <!-- Delete -->
                <form action="{{ route('destroy.donation', $donation->_id) }}" onsubmit="confirmAction(event, () => event.target.submit())" method="post" class="d-inline">
                  @method('DELETE')
                  @csrf
                ...
                <span data-bs-toggle="modal" data-bs-target="#chartModal{{ $donation->_id }}">
                  <button class="btn btn-sm btn-icon" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Chart">
                    <img src="{{asset('assets/img/icons/donations/user-chart.png')}}" alt="user chart" style="width: 1.28vw;height:1.28vw;">
                  </button>
                  @can('donation.write')
                  @endcan
                </span>
              ...
              <div class="modal fade x-modal" id="editModal{{ $donation->_id }}" tabindex="-1" aria-labelledby="editModal{{ $donation->_id }}Label" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    <div class="modal-header bg-custom-grey pb-2">
                      <div class="d-flex w-100">
                        <div class="d-flex justify-content-center align-items-center p-2 gap-1 bg-white rounded-2 mx-auto">
                          <img src="{{asset('assets/img/icons/donations/donate-heart.png')}}" alt="Donate Heart" style="width:2vw;">
                          <h5 class="modal-title fs-3" id="editModal{{ $donation->_id }}Label">Edit Donation</h5>
                        </div>
                      </div>
                    ...
                    <div class="modal-footer p-0 d-flex justify-content-center pb-2">
                      <button type="submit" class="btn btn-light fs-3" form="editForm{{ $donation->_id }}">Update <img src="{{asset('assets/img/icons/donations/send.png')}}" alt="send btn" class="ms-2"></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- User Chat Modal -->
              <div class="modal fade x-modal" id="chartModal{{ $donation->_id }}" tabindex="-1" role="dialog" aria-labelledby="chartModal{{ $donation->_id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header bg-custom-grey p-0 p-3">
                      <div class="modal-title d-flex flex-column"> <h5 class="fs-3 m-0"> {{$donation->title}} </h5> <span class="text-light">{{$donation->type}}</span></div>
                    </div>
                    <div class="modal-body">
                      <div class="col-12 mb-3 bg-custom-grey p-2 rounded-3 px-3">
                        <div class="d-flex justify-content-between align-items-center fs-5 mb-3">
                          <div class="d-flex align-items-center gap-1">
                            <i class="fa fa-circle text-black" style="font-size: 4px;"></i>
                        ...
                        <div class="d-flex justify-content-between mb-2">
                          <div class="border-2 border rounded-3 border-danger" style="width:4.5vw;"></div>
                          <div class="border-2 border rounded-3 border-danger" style="width:4.5vw;"></div>
                          <div class="border-2 border rounded-3 border-warning" style="width:4.5vw;"></div>
                          <div class="border-2 border rounded-3 border-warning" style="width:4.5vw;"></div>
                      ...
                      <div class="col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                          <div class="d-flex align-items-center gap-2">
                            <img src="{{asset('storage/'.$donation->image)}}" alt="user image" class="rounded-circle" style="width: 2.5vw;height:2.5vw;">
                            <div class="d-flex flex-column">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                      <button type="button" class="btn btn-label-secondary fs-5" data-bs-dismiss="modal"><i class="fa fa-circle me-2" style="font-size: 4px;"></i>Close <i class="fa fa-circle ms-2" style="font-size: 4px;"></i></button>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="modal fade x-modal" id="createLimitedModal" tabindex="-1" aria-labelledby="createLimitedModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header bg-custom-grey pb-2">
          <div class="d-flex w-100">
          ...
          <div class="rounded donation-info mb-4 w-75 mx-auto">
            <div class="d-flex w-100 align-items-center justify-content-center h-100">
              ...
              <div class="d-flex flex-column align-items-center gap-2 py-2 w-75">
                ...
                <p class="text-center mb-0 fs-6 px-3" style="color:#FF3257;"> This donation will close automatically once the target amount is reached.</p>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer p-0 d-flex justify-content-center">
          <button type="submit" class="btn btn-light fs-3" form="createUnlimitedForm">Create <img src="{{asset('assets/img/icons/donations/send.png')}}" alt="send btn" class="ms-2"></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade x-modal" id="createUnlimitedModal" tabindex="-1" aria-labelledby="createUnlimitedModalLabel" aria-hidden="true">
          ...
          <div class="rounded donation-info mb-4 x-modal w-75 mx-auto">
            <div class="d-flex w-100 align-items-center justify-content-center h-100">
              ...
              <div class="d-flex flex-column align-items-center py-2 w-75">
                <h5 class="fs-4 text-secondary mb-0">Donation Information</h5>
                <p class="text-center mb-0 fs-6 px-3" style="color:#FF3257;"> The donation will automatically end on the specified date.</p>
              </div>
            </div>
          </div>
          <form id="createUnlimitedForm" action="{{ route('create.donation') }}" method="post" enctype="multipart/form-data" class="x-modal">
              @csrf
                  ...
                  <div class="col-lg-12 mx-auto">
                      <div class="row g-3">
                          ...
                          <div class="col-md-12 bg-custom-grey rounded-3 py-2">
                            <input type="hidden" name="organization_id" id="org_id" required>
                          ...
                          <!-- Banner upload -->
                          <div class="limited-banner col-md-12 bg-custom-grey rounded-3 py-2 border-secondary border-dashed banner-wrapper cursor-pointer">
                          ...
                          <div class="col-md-12 bg-custom-grey rounded-3 py-2">
                              ...
                              <div class="row">
                                  <div class="col-6"><input type="date" class="form-control" name="start_date" placeholder="Start Date" value="{{old('start_date')}}" required></div>
                                  @error('start_date')
                                  <div class="invalid-feedback d-block">{{ $message }}</div>
                                  @enderror
                                  <div class="col-6"><input type="date" class="form-control" name="expired_date" placeholder="Expired Date" value="{{old('expired_date')}}" required></div>
                                  @error('expired_date')
                                  <div class="invalid-feedback d-block">{{ $message }}</div>
                                  @enderror
                              </div>
...
<script>
  $(document).ready(function() {
    ...
    // Click event handler for organization selection
    ...
    $(".category-wrapper").on("click", function() {
     ...
     // Create Form submission handling
      $("#createUnlimitedForm").submit(function(e) {
        e.preventDefault();
          ...
          console.log(organization_id,banner,"ok");
          formSubmitting = true; 
          // $(this).submit();
  ...
  $(document).ready(function() {
    ...
    $('#banner_files').on('change', function(event) {
        ...
        if (file && (file.type === 'image/jpeg' || file.type === 'image/png')) {
            ...
            reader.onload = function(e) {                                
              $('.limited-banner').html(`<img src="${e.target.result}" alt="Banner Image" class="w-100 h-100 object-fit-cover">`);
            }
    ...
    $('#banner').on('change', function(event) {
        ...
        if (file && (file.type === 'image/jpeg' || file.type === 'image/png')) {
            const reader = new FileReader();
            reader.onload = function(e) {                                
              $('.unlimited-banner').html(`<img src="${e.target.result}" alt="Banner Image" class="w-100 h-100 object-fit-cover">`);
            }
            reader.readAsDataURL(file);
        } else {
            alert('Please select a valid JPG or PNG image.');
