                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form id="createForm" method="POST" action="https://dash.yekbun.net/policy_and_terms">
                                <input type="hidden" name="_token" value="V2lq7LnYKWUj06x45EduYQqoEtDMGhg0pawfatwM">
                                <div class="col mb-3">
                                    <label for="nameLarge" class="form-label">Section Name</label>
                                    <input type="text" id="nameLarge" class="form-control"
                                        placeholder="Add Tab Name Here" name="name">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <ul class="nav nav-pills me-3" role="tablist">
                        <li class="nav-item d-flex align-items-center" role="presentation">
                            <button type="button" class="nav-link active " role="tab" data-bs-toggle="tab"
                                data-bs-target="#tab7" aria-controls="tab7" aria-selected="true"><i
                                    class="bx bx-file me-2"></i>Channels Policy</button>

                            <form action="https://dash.yekbun.net/policy_and_terms/7"
                                ...
                                <input type="hidden" name="_method" value="DELETE"> <input type="hidden" name="_token"
                                    value="V2lq7LnYKWUj06x45EduYQqoEtDMGhg0pawfatwM"> <button type="submit"
                                    class="btn btn-sm btn-icon" data-bs-toggle="tooltip" data-bs-offset="0,4"
                                    data-bs-placement="top" data-bs-html="true" data-bs-original-title="Remove"><i
                                        class="bx bx-trash me-1 text-danger delete"></i></button>
                            </form>
                        </li>
                        <li class="nav-item d-flex align-items-center" role="presentation">
                            <button type="button" class="nav-link  " role="tab" data-bs-toggle="tab"
                                data-bs-target="#tab8" aria-controls="tab8" aria-selected="false" tabindex="-1"><i
                                    class="bx bx-file"></i>tyyt</button>

                            <form action="https://dash.yekbun.net/policy_and_terms/8"
                                onsubmit="confirmAction(event, () => event.target.submit())" method="post"
                                class="d-inline">
                                <input type="hidden" name="_method" value="DELETE"> <input type="hidden"
                                    name="_token" value="V2lq7LnYKWUj06x45EduYQqoEtDMGhg0pawfatwM"> <button
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active " id="tab7" role="tabpanel">
                        <form action="{{route('add.policy')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="channel_policy" rows="6" style="resize:none;"></textarea>
                            </div>
                    ...
                    <div class="tab-pane fade show  " id="tab8" role="tabpanel">
                        <form action="" method="POST">
                            <input type="hidden" name="_token" value="V2lq7LnYKWUj06x45EduYQqoEtDMGhg0pawfatwM"> 
                            <input type="hidden" name="tab" value=" tab8 ">
