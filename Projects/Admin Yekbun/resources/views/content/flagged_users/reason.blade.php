                                            ...
                                            <div class="modal-dialog modal-md modal-dialog-centered">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('edit.reason',$reason->_id )}}" method="POST" class="pt-0">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="task-title" placeholder="Title" name="title" value="{{old('title',$reason->title)}}">
                                                        </div>
                                                        <div class="mb-3">
                                                ...
                                                <div class="modal-footer p-0 d-flex justify-content-center pb-2">
                                                  <button type="submit" class="btn btn-light fs-3" form="editForm{{ $reason->_id }}">Update <img src="{{asset('assets/img/icons/donations/send.png')}}" alt="send btn" class="ms-2"></button>
                                                </div>
                                              </div>
                                            </div>
                                        </div>
