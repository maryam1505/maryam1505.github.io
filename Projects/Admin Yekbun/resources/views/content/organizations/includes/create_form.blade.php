<form id="createForm" action="{{ route('add.organization') }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
                ...
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <div class="logo-div-wrapper cursor-pointer">
                        <div class="logo-preview-div position-relative">
                        ...
                        <input type="file" name="image" id="logo_img" class="d-none" required>
                    </div>
                    @error('image')
                ...
                <div class="col-md-12 mb-3">
                    <input type="text" id="inputName" name="organization_name" class="form-control" value="{{ old('organization_name') }}" placeholder="Organization Name" required>
                ...
                <div class="col-md-12 bg-custom-gray rounded py-2">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            <input type="text" name="first_name" class="form-control" placeholder="Owner Name" value="{{old('first_name')}}" required>
                            @error('first_name')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-6 mb-3">
                            <input type="text" name="last_name" class="form-control" placeholder="Owner Last Name" value="{{old('last_name')}}" required>
                            @error('last_name')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md-12 bg-custom-gray rounded py-2">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            <input type="text" name="phone_no" class="form-control" placeholder="Phone No" value="{{old('phone_no')}}" required>
                            @error('phone_no')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card" style="background: #f2f2f2">
                        ...
                        <div class="card-body">
                            <div class="dropzone needsclick" id="dropzone-logo">
                                ...
                                <div class="fallback">
                                    <input type="file" name="logo" id="logo" accept="application/pdf, image/png, image/jpg, image/jpeg" required/>
                                </div>
                            </div>
                        </div>
                    </div>
