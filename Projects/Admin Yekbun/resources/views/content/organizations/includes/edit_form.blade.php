        ...
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <div class="logo-div-wrapper cursor-pointer position-relative rounded-circle">
                        ...
                        <input type="file" name="image" id="logo_img" class="d-none">
                    </div>
                    @error('image')
                                                ...
                                                <div class="dz-preview dz-file-preview w-100">
                                                    <div class="dz-details">
                                                        ...
                                                        <div class="dz-size" data-dz-size></div>
                                                         <a class="dz-remove text-danger" href="javascript:undefined;" data-dz-remove>Remove file</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>`;
