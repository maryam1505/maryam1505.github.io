...
<!--<script src="https://efood-admin.6amtech.com/public/assets/admin/vendor/hs-navbar-vertical-aside/hs-navbar-vertical-aside-mini-cache.js"></script>-->
...
<ul id="navbarSettings" class="js-sticky-block js-scrollspy navbar-nav navbar-nav-lg nav-tabs card card-navbar-nav w-100 d-inline-block p-2">
<li class="nav-item">
...
<div class="col-lg-9">
<form action="javascript:" method="post" enctype="multipart/form-data" id="admin-settings-form">
<input type="hidden" name="_token" value="8iIoEfh7X91IGsczgWabBFvPsp6TzIcbmBWrB59y"> 
...
<img id="viewer" onerror="this.src='https://efood-admin.6amtech.com/public/assets/admin/img/160x160/img1.jpg'" class="avatar-img" src="https://efood-admin.6amtech.com/storage/app/public/admin/2023-09-13-650156f48dc51.png" alt="Image">
...
<label for="firstNameLabel" class="col-sm-3 col-form-label input-label label-has-tooltip">Full name <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="Display name"></i></label>
<div class="col-sm-9">
<div class="input-group input-group-sm-down-break">
<input type="text" class="form-control" name="f_name" id="firstNameLabel" placeholder="Your first name" aria-label="Your first name" value="admin">
<input type="text" class="form-control" name="l_name" id="lastNameLabel" placeholder="Your last name" aria-label="Your last name" value="">
</div>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel" placeholder="+x(xxx)xxx-xx-xx" aria-label="+(xxx)xx-xxx-xxxxx" value="+8801100000000" data-hs-mask-options="{
...
<div class="col-sm-9">
<input type="email" class="form-control" name="email" id="newEmailLabel" value="admin@admin.com" placeholder="Enter new email address" aria-label="Enter new email address">
</div>
</div>
...
<form id="changePasswordForm" action="javascript:" method="post" enctype="multipart/form-data">
<input type="hidden" name="_token" value="8iIoEfh7X91IGsczgWabBFvPsp6TzIcbmBWrB59y">
...
<input type="password" name="password" class="js-toggle-password form-control form-control input-field" id="password" placeholder="Enter new password" required="" data-hs-toggle-password-options="{
...
<br>
<div class="row form-group">
<label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label input-label">Confirm password</label>
<div class="col-sm-9 input-group input-group-merge">
<input type="password" name="confirm_password" class="js-toggle-password form-control form-control input-field" id="confirm_password" placeholder="Confirm your new password" required="" data-hs-toggle-password-options="{
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-sidebar/3.3.2/jquery.sidebar.min.js" integrity="sha512-sE4GyQp4GEFV4qtelZtk1VmjxViVV9zC3PnZCKEjmDIiNZ+MpY/53EKGk+eZUx4FvvH7F2QgduRa2Oxe/pK7fQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-sidebar/3.3.2/jquery.sidebar.js" integrity="sha512-y8re1na3dlaxdUOVLuChUco/+7zYw4QO0ghT2oRW6coXyv8aSNDeSPplNWwzb4Xe58tAQu3Ez3wLwv38/WVGTA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
...
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="https://efood-admin.6amtech.com/public/assets/admin/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
<script>
...
<script>
        ...
        function toogleStatusModal(e, toggle_id, on_image, off_image, on_title, off_title, on_message, off_message) {
            ...
            if ($('#'+toggle_id).is(':checked')) {
                ...
                $('#toggle-status-image').attr('src', "https://efood-admin.6amtech.com/public/assets/admin/img/modal/"+on_image);
                ...
                $('#toggle-status-image').attr('src', "https://efood-admin.6amtech.com/public/assets/admin/img/modal/"+off_image);
                $('#toggle-status-ok-button').attr('toggle-ok-button', toggle_id);
            }
