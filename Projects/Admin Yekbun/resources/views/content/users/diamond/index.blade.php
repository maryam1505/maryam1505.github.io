        ...
        <div class="table-responsive text-nowrap pd-t-24px">
          <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <td>
                  <div class="d-flex justify-content-start align-items-center user-name">
                    ...
                    <div class="d-flex flex-column">
                      <a href="{{url('vip/app/user/view/Follower')}}" class="text-body text-truncate">
                        <span class="fw-semibold">Lawand ABBAS</span>
                      </a>
                      <small class="text-muted">lawandabbas95@gmail.com</small>
                    </div>
                  </div>
                </td>
                <td></td>
                <td></td>
                <td>September 10th, 2023</td>
                <td>0</td>
                <td>
                ...
                <td>
                  <div class="dropdown">
                    <span data-bs-toggle="modal" data-bs-target="#blockModal1">
                    ...
                    <span data-bs-toggle="modal" data-bs-target="#warnModal1">
                    ...
                    <span data-bs-toggle="modal" data-bs-target="#upgradeModal1">
                    ...
                    <form action="https://dash.yekbun.net/users/standard/25" onsubmit="confirmAction(event, () => event.target.submit())" class="d-inline" method="post">
                      <input type="hidden" name="_method" value="DELETE">                      <input type="hidden" name="_token" value="jAAxQwh000pW7rwOdU3GSZko4RKRVixUksX5B97n">                                            <button type="submit" class="btn btn-sm btn-icon" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Remove"><i class="bx bx-trash me-1"></i></button>
                                          </form>
                           ...
                           <?php
                                  ...
                                  <tbody class="table-border-bottom-0">
                                <tr>
                  <td class="text-center" colspan="6"><b>No users found.<b></b></b></td>
                </tr>
                              </tbody>
                            <?php  }
                              ?>
...
<x-modal id="editModal{{ $user->id }}" title="Edit VIP User" saveBtnText="Update" saveBtnType="submit" saveBtnForm="editForm{{ $user->id }}" size="xl" :show="old('showEditFormModal'.$user->id)? true: false">
...
<x-modal id="createModal" title="Add VIP User" saveBtnText="Create" saveBtnType="submit" saveBtnForm="createForm" size="xl" :show="old('showCreateFormModal')? true: false">
