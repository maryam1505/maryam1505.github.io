            ...
            <tbody class="table-border-bottom-0">
                ...
                <td>
                  <div class="d-flex justify-content-start align-items-center user-name">
                    ...
                    <div class="d-flex flex-column">
                      <a href="{{url('premium/app/user/view/Follower')}}" class="text-body text-truncate">
                        <span class="fw-semibold">Ali khan</span>
                      </a>
                      <small class="text-muted">user9585497@gmail.com</small>
                    </div>
                  </div>
                </td>
                <td></td>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <form action="https://dash.yekbun.net/users/standard/26" onsubmit="confirmAction(event, () => event.target.submit())" class="d-inline" method="post">
                ...
                <td>
                  <div class="d-flex justify-content-start align-items-center user-name">
                    ...
                    <div class="d-flex flex-column">
                      <a href="{{url('premium/app/user/view/Follower')}}" class="text-body text-truncate">
                        <span class="fw-semibold">Zoukar Sulaiman</span>
                      </a>
                      <small class="text-muted">s-cs@hotmail.de</small>
                    </div>
                  </div>
                </td>
                <td></td>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <form action="https://dash.yekbun.net/users/standard/22" onsubmit="confirmAction(event, () => event.target.submit())" class="d-inline" method="post">
                      <input type="hidden" name="_method" value="DELETE">                      <input type="hidden" name="_token" value="jAAxQwh000pW7rwOdU3GSZko4RKRVixUksX5B97n">                                            <button type="submit" class="btn btn-sm btn-icon" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Remove"><i class="bx bx-trash me-1"></i></button>
                                          </form>
