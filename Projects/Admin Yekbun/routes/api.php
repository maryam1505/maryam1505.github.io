...
use App\Http\Controllers\Admin\Donation\OrganizationController as DonationOrganizationController;
...
Route::post('/edit_channel_subcategory', [ChannelCategoryController::class, 'edit_channel_subcategory'])->name('edit.channel.subcat');
...
Route::put('/edit_channel_reason',[ChannelReasonController::class, 'edit_reason'])->name('edit.reason');
...
/*--------------------------
 Organization
----------------------------*/
Route::post('/add_organization', [DonationOrganizationController::class, 'add_organization'])->name('add.organization');
Route::delete('/delete_organization/{id}', [DonationOrganizationController::class, 'organization_destroy'])->name('organization.destroy');
Route::put('/organization_update/{id}', [DonationOrganizationController::class, 'organization_update'])->name('organization.update');
