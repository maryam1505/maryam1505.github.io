    ...
    ***********************************-->
                            ...
                            <div class="card-body p-4">
                                <div class="media">
                                    ...
                                    <div class="media-body text-white text-right">
                                        <p class="mb-1">City</p>
                                        <h3 class="text-white"> {{ $totalCityCount }}</h3>
    ...
    <div class="card-body p-4">
        <div class="media">
            ...
            <div class="media-body text-white text-right">
                <p class="mb-1">Places</p>
                <h3 class="text-white">{{ $totalPlaceCount }}</h3> <!-- Display total places count -->
                <div class="progress mb-2 bg-secondary">
                                            <div class="progress-bar progress-animated bg-light" style="width: 80%">
                                            </div>
                                        </div>
                            ...
                            <div class="items">
                                <div class="text-center">
                                    ...
                                    <h5 class="mb-0"><a class="text-black"
                                            href="javascript:void(0);">{{ $user->name }}</a></h5>
                                    <span class="fs-12">{{ '@' . $user->username }}</span>
                                </div>
                            </div>
                            @endforeach
            ...
            <div class="col-xl-12 mt-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3 mt-3 justify-content-between align-items-center">
                            <h4 class="text-black fs-20 mb-0">Recent Places</h4> <a href="/admin/place"
                        ...
                        <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                            ...
                            <div class="item">
                                <div class="card">
                                    <img src="{{ asset('storage/' . $place->image) }}" class="card-img-top"
                                        alt="{{ $place->place_name }}">
                                    <div class="card-body">
                                            <h5 class="mb-0"><a class="text-black"
                                            href="javascript:void(0);">{{ $place->place_name }}</a></h5>
                                     </div>
                                </div>
                            </div>
                            @endforeach
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="../index.htm" target="_blank">Cultural</a>
                2024</p>
        </div>
    </div>
    <!--**********************************
