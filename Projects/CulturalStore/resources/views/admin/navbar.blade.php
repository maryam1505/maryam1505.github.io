                    ...
                    <div class="card mb-sm-3 mb-md-0 contacts_card">
                        ...
                        <div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body1">
                            <ul class="contacts">
                                ...
                                <li>
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont primary">AU<i class="icon fa fa-user-plus"></i>
                                        </div>
                                        <div class="user_info">
                                            <span>AharlieKane</span>
                                            <p>Sami is online</p>
                                ...
                                <li>
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont info">MO<i class="icon fa fa-user-plus"></i>
                                        </div>
                                        <div class="user_info">
                                            <span>Athan Jacoby</span>
                                            <p>Nargis left 30 mins ago</p>
        ...
        <div class="header-content">
                    ...
                    <ul class="navbar-nav header-right main-notification">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            ...
                            <link rel="stylesheet"
                                ...
                                integ2-1ALHqwAY16o6hkjmNffHZxUOqjiv6IfgFt1TnHGOF67Fw7RWx99I66NHTbLrPIEJQ6RglaL+GSDcz0Xl1zHTA=="
                        crossorigin=" anonymous" referrerpolicy="no-referrer" />
                            <div class="dropdown-menu dropdown-menu-right" href="admin/users">
                                <div id="dlab_W_Notification1" class="dz-scroll p-3 height380">
                                    <ul class="timeline">
                                ...
                                <a class="all-notification" href="javascript:void(0)" id="notificationLink">
                                    <!-- Calculate and display the total number of notifications -->
            ...
            <div class="sub-header">
                ...
                <div class="d-flex align-items-center">
                    <a href="javascript:void(0);" class="btn btn-xs btn-primary light">Hunarmand</a>
                </div>
            </div>
        </div>
    </div>