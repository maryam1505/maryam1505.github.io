...
<body>
    ...
    ***********************************-->
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Places</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-primary btn-sm mb-2" data-toggle="modal"
                                data-target="#basicModal">Add Place</button>
                            <div class="modal fade" id="basicModal" tabindex="-1" role="dialog"
                                aria-labelledby="basicModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="basicModalLabel">Add Place </h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="placeForm" action="{{ route('admin.newplace') }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span id="placeNameError" class="text-danger"></span>
                                                </div>
                                                ...
                                                function(event) {
                                                    ...
                                                    reader.onload = function(e) {
                                                        ...
                                                        imagePreview.style.display =
                                                            'block'; // Display the image preview
                                                    };
                            ...
                            <div class="table-responsive">
                                <table class="table table-responsive-md">
                                    ...
                                    <tbody id="userTableBody">
                                        ...
                                        <tr id="placeRow{{ $place->place_id }}">

                                            <td>{{ $loop->iteration }}</td>
                                            <td>
                                                @if(strpos($place->location, '<iframe') !==false) <a href="#"
                                                    data-toggle="modal" data-target="#mapModal-{{ $place->id }}">
                                                    <span class="badge badge-info">Map added</span>
                                                    </a>
                                                    @else
                                                    {{ $place->location }}
                                                    @endif
    ...
    <p style="max-width: 50%; max-height: 50%;  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{!! $place['location'] !!}</p>
//</td> -->
                                            ...
                                            <td>
                                                @php
                                                $cityName = $place->city->city_name;
                                                $badgeColor = '';


                                                if ($cityName === 'Islamabad') {
                                                $badgeColor = 'badge-success';
                                                } elseif ($cityName === 'Rawalpindi') {
                                                ...
                                                <span class="badge {{ $badgeColor }}">{{ $cityName }}</span>
                                            </td>

                                            <td>
                                                <img src="{{ asset('storage/' . $place->image) }}" alt="Profile Picture"
                                                    width="40" height="40">
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="#"
                                                        class="btn btn-primary shadow btn-xs sharp mr-1 edit-place"
                                                        data-toggle="modal"
                                                        data-target="#updateModal{{ $place->place_id }}">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <form id="deleteForm"
                                                        action="{{ route('admin.deletePlace', $place->place_id ) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                        ...
                                        <div class="modal fade" id="updateModal{{ $place->place_id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="updateModalLabel{{ $place->place_id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="updateModalLabel{{ $place->place_id }}">
                                                            Update Place
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form to update place details -->
                                                        <form id="updatePlaceForm{{ $place->place_id }}"
                                                            action="{{ route('admin.updatePlace', ['id' => $place->place_id]) }}"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="place_name">Place Name:</label>
                                                                <input type="text" class="form-control" id="place_name"
                                                                    name="place_name" value="{{ $place->place_name }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="place_name">Location:</label>
                                                                <input type="text" class="form-control" id="location"
                                                                    name="location" value="{{ $place->location }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="place_name">History:</label>
                                                                <input type="text" class="form-control" id="history"
                                                                    name="history" value="{{ $place->history }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="description">Description:</label>
                                                                <textarea class="form-control" id="description"
                                                                    name="description"
                                                                    rows="3">{{ $place->description }}</textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="city_id">City:</label>
                                                                <select class="form-control" id="city_id"
                                                                    ...
                                                                    <option value="{{ $city->city_id }}"
                                                                        {{ $city->city_id == $place->city_id ? 'selected' : '' }}>
                                                                        {{ $city->city_name }}
                                                                    </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <img src="{{ asset('storage/' . $place->image) }}"
                                                                    id="imagePreview" alt="Place Image"
