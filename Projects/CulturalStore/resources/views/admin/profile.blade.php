...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <a href="/admin/dashboard" class="brand-logo">
                ...
                <img src="{{ asset('storage/downloads/download.png') }}" width="40px" height="40px" alt="Profile Picture"
                    class="logo-img">
    ...
    <label>Email</label>
    <div class="input-group">
        <input name="bio" value="{{ $LoggedAdminInfo['email'] }}" disabled class="form-control" placeholder="Bio">
        <div class="input-group-append">
            <span class="input-group-text">
                <i class="fas fa-info-circle" id="emailInfo"></i>
            </span>
        </div>
    </div>
</div>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var emailInput = document.querySelector('input[name="bio"]');
        var emailInfo = document.getElementById('emailInfo');
        
        emailInput.addEventListener('click', function() {
            alert("Email cannot be modified");
        });
    ...
    <input type="file" name="picture" id="newPicture" class="form-control-file" onchange="previewImage(event)">
</div>

<div class="form-group" id="imagePreviewContainer" style="display: none;">
    <label>Preview</label><br>
    <img id="imagePreview" src="#" alt="New Profile Picture" width="100" height="100">
</div>
...
<script>
    function previewImage(event) {
        ...
        ***********************************-->
            <div class="footer">
                <div class="copyright">
                    <p>Copyright © Designed &amp; Developed by <a href="../index.htm" target="_blank">Mispa Motor</a>
                        2024</p>
                </div>
            </div>
            <!--**********************************
