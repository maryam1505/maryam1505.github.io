                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Company </h4><button type="button"
                                class="btn btn-primary btn-sm mb-2" data-toggle="modal" data-target="#basicModal">Add
                                Company</button>
                        ...
                        <div class="modal fade" id="basicModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="basicModalLabel">Add Company </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ route('admin.newcompany') }}" method="POST"
                                            ...
                                            <div class="form-group" id="imagePreviewContainer" style="display: none;">
                                                ...
                                                <img id="imagePreview" src="#" alt="New Profile Picture" width="100"
                                                    height="100">
                                            </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit"
                                            class="btn btn-sm btn-primary">{{ isset($company) ? 'Update User' : 'Add Company' }}</button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="{{ asset('path_to_default_image.jpg') }}"
                                                    alt="Default Picture" width="100" height="100">
                                                @endif
                                            </td>
                                            <td>{{ $company->name }}</td>
                                            <td>
                                            ...
                                            <td>
    <div class="d-flex">
        <a href="#" class="btn btn-primary shadow btn-xs sharp mr-1 edit-company" data-toggle="modal" data-target="#updateModal{{ $company->id }}">
...
<form action="{{ route('admin.deactivatecompany', ['id' => $company->id]) }}" method="post">
    @csrf
    @method('PUT')
    <button type="submit" class="btn btn-danger btn-xs">Deactivate</button>
</form>
@else
<form action="{{ route('admin.activatecompany', ['id' => $company->id]) }}" method="post">
    @csrf
    @method('PUT')
...
@endif
                                        ...
                                        <!-- Update Modal for current company -->
                                        <div class="modal fade" id="updateModal{{ $company->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="updateModalLabel{{ $company->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="updateModalLabel{{ $company->id }}">
                                                            Update
                                                            Company</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form to update company details will be populated here -->
                                                        <form id="updateCompanyForm{{ $company->id }}"
                                                            action="{{ route('admin.updatecompany', ['id' => $company->id]) }}"
    ...
    <input type="file" name="image" class="form-control-file" id="imageInput{{ $company->id }}">
    <label>Preview</label><br>

    <div style="position: relative; width: 150; height: 150px; border: 1px solid #ccc; overflow: hidden;"> <!-- Adjust width and height as needed -->
        <img id="imagePreview{{ $company->id }}" src="{{ asset('storage/' . $company['image']) }}" alt="Image Preview" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); max-width: 100%; max-height: 100%;">
    </div>
</div>
                                                        ...
                                                        $(document).ready(function() {
                                                            $('#updateModal{{ $company->id }}').on(
                                                                'show.bs.modal',
                                                                function() {
                                                                    $('#imageInput{{ $company->id }}').on(
                                                                        'change',
                                                                        function(event) {
                                                                            var file = event.target
                                                                                .files[0];
                                                                            var imagePreview = $(
                                                                                '#imagePreview{{ $company->id }}'
                                                                            )[0];
