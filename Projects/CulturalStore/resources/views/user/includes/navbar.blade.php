                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('storage/' . $LoggedUserInfo['picture']) }}" alt="Profile Picture"
                                width="100" height="100">
                            @else
                            <img rounded src="{{ asset('path_to_default_image.jpg') }}" alt="Default Picture"
                                width="100" height="100">
                            @endif
                            <div class="header-info">
                                <h5 class="name"><span class="font-w400"></span> {{ $LoggedUserInfo['name'] }}</h5>
                                <small> User</small>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <form id="logout-form" action="http://127.0.0.1:8000/user/logout">
                                <input type="hidden" name="_token" value="pK0Sf9qozEVTKVoA4PchSFT5n0AdcuRK7f4TWETa"
                                    autocomplete="off"> <button type="submit" class="dropdown-item ai-icon"
