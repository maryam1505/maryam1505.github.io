    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <div class="related__title">
                <h5>Most Wanted Women Dresses</h5>
            </div>
        </div>
...
<li>
                        <a href="{{ route('productdetails', ['id' => $product->ProductID]) }}" class="product-details-link">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <div class="related__title">
                <h5>Most Wanted Women Jewelery</h5>
            </div>
        </div>
                ...
                <div class="product__item__pic set-bg" data-setbg="{{ asset('storage/' . $product->ProductImage) }}"
                    ...
                    <ul class="product__hover">
                        ...
                        <li><a href="{{ route('productdetails', ['id' => $product->ProductID]) }}"
                                ...
                                data-image="{{ asset('storage/' . $product->ProductImage) }}"><span
                                class="fas fa-eye"></span></a></li>
                    </ul>
                </div>
                <div class="product__item__text">
                    <h6><a href="#">{{ $product->ProductName}}</a></h6>
